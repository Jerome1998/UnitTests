...
namespace UnitTests.Tests.Mocking
{
    ...
    public class BookingHelper_OverlappingBookingsExistTests
    {
        ...
        private Fake<IBookingRepository> _repository;
        ...
        public void SetUp()
        {
            ...
            _repository = new Fake<IBookingRepository>();
            _repository.CallsTo(r => r.GetActiveBookings(1)).Returns(new List<Booking>
            {
                _existingBooking
            }.AsQueryable());
        }
